          ...
          <div className='relative w-[448px] h-[366px] bg-white rounded-md shadow flex-col justify-start items-center inline-flex'>
            ...
            <div className='self-stretch h-[234px] px-6 py-2 flex-col justify-start items-start gap-2.5 flex'>
              ...
              <div className='flex-col justify-start items-start gap-1 flex'>
                ...
                <Checkbox
                  checked={actions.createItem}
                  label='Create item'
                  handleCheckboxChange={handleCheckboxChange}
                  name='createItem'
                />
                <Checkbox
                  checked={actions.deleteItem}
                  label='Delete item'
                  handleCheckboxChange={handleCheckboxChange}
                  name='deleteItem'
                />
                <Checkbox
                  checked={actions.viewItem}
                  label='View item'
                  handleCheckboxChange={handleCheckboxChange}
                  name='viewItem'
                />
                <Checkbox
                  checked={actions.moveItem}
                  label='Move item'
                  handleCheckboxChange={handleCheckboxChange}
                  name='moveItem'
                />
...
const Checkbox = ({ label, name, checked, handleCheckboxChange }) => {
  return (
